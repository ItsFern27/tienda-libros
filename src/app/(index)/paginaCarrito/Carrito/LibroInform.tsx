    ...
    >
      ...
      <div className="w-[70%] h-full flex flex-row">
        ...
        <div className="w-[60%] flex justify-center items-center">
          <div className="w-8/10 h-5/10 flex flex-rwo bg-gray-300 rounded-2xl justify-center items-center">
            <span className=" w-5/10 font-black text-center">{`S/ ${(precio * cantidad)}`}</span>
            <div className="flex flex-row w-4/10 h-6/10 rounded-2xl justify-around items-center bg-gray-100">
              <button
